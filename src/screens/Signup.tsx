...
import TermsSheet from '../components/common/TermsSheet';
...
export default function Signup({ onContinue }: SignupProps) {
  ...
  return (
    <>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                textDecorationColor: 'rgba(245,240,230,0.35)',
      ...
      {openDoc === 'terms' && (
        <TermsSheet kind="terms" onClose={() => setOpenDoc(null)} />
      )}
      {openDoc === 'privacy' && (
        <TermsSheet kind="privacy" onClose={() => setOpenDoc(null)} />
      )}
    </>
  );
}